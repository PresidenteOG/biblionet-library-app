...
import com.biblionet.data.repository.book.CategoriaRepository // IMPORT CORREGIDO
import com.biblionet.data.repository.book.LibroRepository
import com.biblionet.data.repository.book.ComentarioRepository
import com.biblionet.data.repository.inventory.InventarioRepository
import com.biblionet.data.repository.inventory.BibliotecaRepository
...
class BookViewModel : ViewModel() {
    ...
    fun toggleCensura(comentario: Comentario) {
        if (GlobalState.usuario?.rol != com.biblionet.data.model.auth.Role.ADMIN) {
